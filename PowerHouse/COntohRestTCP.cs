...
namespace HTTPRestTest
{
    class COntoh
    {
        ...
        /// <summary>
        /// Send a single.StackTrace to a user in your ZEEP account.
        /// </summary>
        ...
        /// <param name="user">UserId in your Zeep System. Only required if your sending a Single.StackTrace to a User.
