...
{
    class TCPPersadaClient: IDisposable
    {
        #region Disposable
        ...
        string persadaQueueHost = "";
        int persadaQueuePort = 0;

        public TCPPersadaClient(string PersadaQueueHost, int PersadaQueuePort)
        {
            persadaQueueHost = PersadaQueueHost;
            persadaQueuePort = PersadaQueuePort;
        }
        ...
        private bool Connect()
        {
            ...
            int timeout = 3;
            LOG_Handler.LogWriter.showDEBUG(this, "Persada > " + persadaQueueHost+ ":" + persadaQueuePort.ToString());
            while(true)
            {
                tcpclnt.Connect(persadaQueueHost, persadaQueuePort);
...
//            int timeout = 10;
            ...
            while (true)
            {
                ...
                if ((short)(tLen - 4) == msgLen)
                {
                    ...
                    //Console.WriteLine("Terima Ti persada = " + sb);
