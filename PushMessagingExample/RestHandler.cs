...
//				}
		...
		public void HTTPHeaderBuilder()
		{
			try
			{
				...
				//                    request.Headers.Add(HttpRequestHeader.Authorization, contentParam);
					...
					Console.WriteLine ("Authorization: " + authParam);
		...
		public bool HTTPSendBody()
		{
			...
			Console.WriteLine (SendHttpString);
			try{
				...
				Console.WriteLine ("DEBUG 5 " + ex.Message);
				return false;
			}
		}

//		public bool HttpsSender(){
//			string[] str = { "huntu1", "huntu2" }; // data anu di posting
//			string url = "https://qiosku.com/tes.php"; // URL na
//
//			System.Net.ServicePointManager.CertificatePolicy = new DummyPolicy();
//
//			HttpWebRequest httpWReq = (HttpWebRequest)WebRequest.Create(url);
//			ASCIIEncoding encoding = new ASCIIEncoding();
//			//httpWReq.Timeout = 120 * 100;
//			//				request.UserAgent = "Mozilla/5.0 (Windows NT 6.1; WOW64; rv:8.0) Gecko/20100101 Firefox/8.0";
//			//				request.Referer = "https://www.majesticseo.com/account/login";
...
//
//			string postData = "";
//			postData += "message1=" + str[0] + "&";
//			postData += "message2=" + str[1];
//
//			byte[] data = encoding.GetBytes(postData);
//			string authParam = "Authorization: DA01 dam:bcdYsf6o/MrAwnL3RRBdm5hpceA=";
//
//			httpWReq.Method = "POST";
//			httpWReq.Date = DateTime.Now;
//			httpWReq.Headers.Add (HttpRequestHeader.Authorization, authParam);
//
//
//			httpWReq.ContentType = "application/json";
...
//					}
        ...
        private string sendByTCP(string requestHeaders, string body, string parameters, int recTimeOut)
        {
			...
			Console.WriteLine ("SEND: " + requestMethod + requestHeaders + parameters + "\r\n");
...
//						else
			...
			Console.WriteLine ("*=*=*=*=*=  TERIMA dr host REST =========\r\n" + responseData);
            // Close everything.
			try{
