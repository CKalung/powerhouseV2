...
//            return true;
        ...
        private string ConstructObject()
        {
            ...
            foreach (DictionaryEntry de in this)
            {
                ...
                else if (de.Value.GetType().Equals(typeof(System.Decimal)))
                {
                    json += "\"" + fieldName + "\":" + ((System.Decimal)de.Value).ToString("0.00##########################");   // 28 digit max
                }
                else if (de.Value.GetType().Equals(typeof(System.Double)))
                {
                    json += "\"" + fieldName + "\":" + ((System.Double)de.Value).ToString("0.00#############"); // 15 digit max
                }
                else if (de.Value.GetType().Equals(typeof(System.Single)))
                {
                    json += "\"" + fieldName + "\":" + ((System.Single)de.Value).ToString("0.00#####"); // 7 digit max
                }
